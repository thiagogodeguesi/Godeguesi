...
export const professionalProfile = {
  ...
  approach: [
    "Entender o contexto antes de propor mudanças.",
    "Evoluir soluções por etapas, com arquitetura e qualidade como parte do trabalho.",
  ...
  workPrinciples: [
    ...
    "Colaboração entre produto e tecnologia",
  ],
} as const;
